...
if __name__ == "__main__":
    ...
    # MODEL = load_model("./lstm_genre_classifier_lstm.json", "./lstm_genre_classifier_lstm.json")
    "Loading trained model..."
    MODEL = keras.models.load_model('./lstm_genre_classifier_lstm.h5')
    "Finished loadding, now predicting"
